...
def extend_cfg(cfg):
    ...
    # Config for COMMA
    cfg.TRAINER.COMMA = CN()
    cfg.TRAINER.COMMA.N_CTX = 2  # number of context vectors
    cfg.TRAINER.COMMA.CTX_INIT = "a photo of a"  # initialization words
    cfg.TRAINER.COMMA.PREC = "fp16"  # fp16, fp32, amp
    cfg.TRAINER.COMMA.WEIGHT = 1.0  # weight for the cos similarity
    cfg.TRAINER.COMMA.LAST_LAYER = 1 # number of the last layers 
    cfg.TRAINER.COMMA.PROMPT_DEPTH = 9 # Max 12, minimum 0, for 1 it will act as shallow MaPLe (J=1)
    cfg.DATASET.SUBSAMPLE_CLASSES = "all"  # all, base or new
